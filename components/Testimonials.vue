<template>
  <!-- component -->
  <div class="py-16 bg-emerald-900">
    <div class="container m-auto px-6 text-white md:px-12 xl:px-6">
      <h2 class="mb-12 text-center text-2xl text-white font-bold md:text-4xl">
      ...
      <div class="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
        ...
        >
          <div class="h-full flex flex-col justify-center space-y-4">
            ...
            <div>
              <h6 class="text-lg text-black font-semibold leading-none">
                Jane Doe
              </h6>
              <span class="text-xs text-gray-900">Product Designer</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
            ...
            <div>
              <h6 class="text-lg text-black font-semibold leading-none">Jane Doe</h6>
              <span class="text-xs text-gray-900">Product Designer</span>
            </div>
          </div>
        </div>
